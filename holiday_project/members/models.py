...
class offerAMS(models.Model):
    id = models.DecimalField(max_digits=9, decimal_places=0, primary_key=True)
    countadults = models.DecimalField(max_digits=2, decimal_places=0)
    countchildren = models.DecimalField(max_digits=2, decimal_places=0)
...
class first(models.Model):
    id = models.DecimalField(max_digits=9, decimal_places=0, primary_key=True)
    mealtype = models.DecimalField(max_digits=1, decimal_places=0)
    oceanview = models.BooleanField()
    price = models.DecimalField(max_digits=6, decimal_places=0)
    roomtype = models.DecimalField(max_digits=2, decimal_places=0)
